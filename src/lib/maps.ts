...
export const CITY_POIS: Record<string, POI[]> = {
  Rotterdam: [
    ...
    { id: "rtm-uni", name: "Erasmus University Rotterdam (EUR)", category: "university", address: "Burgemeester Oudlaan 50, 3062 PA Rotterdam", lat: 51.9176, lng: 4.5269, note: "Student Service Centre (SSC) runs BRP registration days for new internationals." },
    { id: "rtm-uni2", name: "Rotterdam University of Applied Sciences (Hogeschool Rotterdam)", category: "university", address: "Wijnhaven 107, 3011 WN Rotterdam", lat: 51.9178, lng: 4.4868, note: "International Office at Wijnhaven. Contact them for BRP fast-track days." },
    { id: "rtm-uni3", name: "Codarts University of the Arts", category: "university", address: "Kruisplein 26, 3012 CC Rotterdam", lat: 51.9205, lng: 4.4695, note: "International admissions via codarts.nl/en." },
  ...
  Utrecht: [
    ...
    { id: "utr-uni", name: "Utrecht University (Universiteit Utrecht)", category: "university", address: "Heidelberglaan 8, 3584 CS Utrecht", lat: 52.0855, lng: 5.1781, note: "International Office at Bestuursgebouw, Utrecht Science Park. Runs BRP days in September." },
    { id: "utr-uni2", name: "HU University of Applied Sciences Utrecht", category: "university", address: "Padualaan 101, 3584 CH Utrecht", lat: 52.0841, lng: 5.1720, note: "International Office at Heidelberglaan campus." },
